...
timer.grid(row=18, column=1, columnspan=1, sticky=W)

progressbar = ttk.Progressbar(frame)
progressbar.grid(row=18, column=0, columnspan=2, sticky=W)
...
def report_coretracker(polarity):
...
def next_ovf():
    ...
    if current_ovf.get() < total_frames:
